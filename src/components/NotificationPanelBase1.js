...
const NotificationPanelBase1 = ({ className = "" }) => {
  return (
    <div
...
NotificationPanelBase1.propTypes = {
  className: PropTypes.string,
};

export default NotificationPanelBase1;
